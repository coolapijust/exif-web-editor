...
export const translations: Translations = {
  'zh-CN': {
    ...
    editor: {
      ...
      clearError: '清除标签失败',
      editTag: '编辑标签',
      editTip: '如果编辑后的结果没有被保存，是因为此标签本身不可编辑。',
      enterValue: '输入值',
      valueRequired: '请输入值',
      arrayHint: '多个值请用逗号分隔',
      saving: '保存中...'
  ...
  'en-US': {
    ...
    app: {
      title: 'EXIF Editor',
      pageTitle: 'EXIF Editor - View and Edit Image Metadata',
    ...
    info: {
      downloadModified: 'Download Modified Image',
    ...
    editor: {
      ...
      editTag: 'Edit Tag',
      editTip: 'If the edited result was not saved, it is because this tag is not editable by nature.',
      enterValue: 'Enter value',
      valueRequired: 'Value is required',
      arrayHint: 'Separate multiple values with commas',
      saving: 'Saving...'
    },
    notifications: {
